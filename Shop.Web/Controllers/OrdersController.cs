...
namespace Shop.Web.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        { 
        var model = await this.orderRepository.GetOrdersAsync(this.User.Identity.Name);
            return View(model);
        ...
        {
            var model = await this.orderRepository.GetOrderDetailTempAsync(this.User.Identity.Name);
            return View(model); 
        ...
        {
            var response = await orderRepository.ConfirmOrderAsync(this.User.Identity.Name);
            if (response)
            {
